package eclipse.sportsBrain.e4.cards.login.internal;
...
public class LoginDialog extends Dialog {
	...
	protected Composite createContentArea(Composite parent) {
		...
		if (imageDescriptor == null) {
			imageDescriptor = imageDescriptorFromURI(URI.createURI("platform:/plugin/eclipse.sportsBrain.e4.cards.login/images/juno.png"));
		}
		if (imageDescriptor != null) {
