/**
 */
package eclipse.sportsBrain.e4.cards.model.application.ui.basic.util;

import eclipse.sportsBrain.e4.cards.model.application.ui.basic.*;
 ...
 * <!-- end-user-doc -->
 * @see eclipse.sportsBrain.e4.cards.model.application.ui.basic.BasicPackage
 * @generated
 */
public class BasicSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BasicPackage.TUTORIAL_PART_STACK: {
				TutorialPartStack tutorialPartStack = (TutorialPartStack)theEObject;
				T1 result = caseTutorialPartStack(tutorialPartStack);
				if (result == null) result = casePartStack(tutorialPartStack);
				if (result == null) result = caseGenericStack(tutorialPartStack);
				if (result == null) result = casePartSashContainerElement(tutorialPartStack);
				if (result == null) result = caseWindowElement(tutorialPartStack);
				if (result == null) result = caseElementContainer(tutorialPartStack);
				if (result == null) result = caseUIElement(tutorialPartStack);
				if (result == null) result = caseApplicationElement(tutorialPartStack);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tutorial Part Stack</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tutorial Part Stack</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseTutorialPartStack(TutorialPartStack object) {
		return null;
	}
